...
public class RadioTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		sb.append("    <input type=\"checkbox\" name=\"");sb.append(name);sb.append("\"  value=\"");sb.append(value);sb.append("\" style=\"position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);\">\r\n");
