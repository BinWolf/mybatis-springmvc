...
/*    if ($.fn.xheditor) {
    ...
    if ($.fn.uploadify && $.fn.Huploadify) {
        $(":file[uploaderOption]", $p).each(function(){
            var $this = $(this);
            var options = {
                swf:'/platform/DWZ/plugins/uploadify/scripts/uploadify.swf',
                ...
                previewLoadimg:'/platform/DWZ/plugins/Huploadify/images/loading.gif', //预览前的载入图标
                dragDrop:true,
    ...
    $('textarea.j-content', $p).each(function() {
        ...
        KindEditor.create(editor, {
            ...
            htmlTags                 : htmlTags,
            cssPath                  : $("#home").val()+'/platform/DWZ/editor-content.css',
